  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -left-16 sm:left-auto sm:right-0 mt-[17px] flex h-[480px] w-[290px] sm:w-[361px] flex-col rounded-2xl border border-gray-200 bg-white p-4 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
